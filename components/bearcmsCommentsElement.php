...
if (strlen($threadID) > 0) {
    ...
    $content .= '<script id="bearcms-bearframework-addon-script-5" src="' . htmlentities($context->assets->getUrl('components/bearcmsCommentsElement/assets/commentsElement.js', ['cacheMaxAge' => 999999999, 'version' => 1])) . '" async></script>';
