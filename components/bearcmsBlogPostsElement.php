...
?><html>
    <head><?php
        if ($list->length > $limit) {
            ...
            echo '<script id="bearcms-bearframework-addon-script-4" src="' . htmlentities($context->assets->getUrl('assets/HTML5DOMDocument.min.js', ['cacheMaxAge' => 999999, 'version' => 1])) . '"></script>';
        }
        ?></head>
    <body><?= $content ?></body>
</html>