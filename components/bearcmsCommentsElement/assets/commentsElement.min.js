...
a.target;a.querySelector(".bearcms-comments-element-send-button").style.display="inline-block";a.querySelector(".bearcms-comments-element-send-button-waiting").style.display="none";a.querySelector(".bearcms-comments-element-text-input").removeAttribute("readonly")},onFocusTextarea:function(a){c(a);a=a.target.parentNode;"none"===a.querySelector(".bearcms-comments-element-send-button-waiting").style.display&&(a.querySelector(".bearcms-comments-element-send-button").style.display="inline-block")}}}();