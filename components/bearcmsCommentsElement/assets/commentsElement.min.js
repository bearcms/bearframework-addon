...
a.target.querySelector('input[type="hidden"]').value=JSON.stringify({listElementID:b,listCommentsCount:d})},onSubmitFormDone:function(a){var b=a.target;a=a.result;"undefined"!==typeof a.success&&b.reset();e(a)},onFormRequestSent:function(a){a=a.target;a.querySelector(".bearcms-comments-element-send-button").style.display="none";a.querySelector(".bearcms-comments-element-send-button-waiting").style.display="inline-block";a.querySelector(".bearcms-comments-element-text").setAttribute("readonly","readonly")},
onFormResponseReceived:function(a){a=a.target;a.querySelector(".bearcms-comments-element-send-button").style.display="inline-block";a.querySelector(".bearcms-comments-element-send-button-waiting").style.display="none";a.querySelector(".bearcms-comments-element-text").removeAttribute("readonly")},onFocusTextarea:function(a){a=a.target.parentNode;"none"===a.querySelector(".bearcms-comments-element-send-button-waiting").style.display&&(a.querySelector(".bearcms-comments-element-send-button").style.display=
"inline-block")}}}();