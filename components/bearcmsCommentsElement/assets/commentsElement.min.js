...
JSON.stringify({listElementID:b,listCommentsCount:e})}},onSubmitFormDone:function(a){var b=a.target;a=a.result;"undefined"!==typeof a.success&&b.reset();f(a)},onFormRequestSent:function(a){a=a.target;a.querySelector(".bearcms-comments-element-send-button").style.display="none";a.querySelector(".bearcms-comments-element-send-button-waiting").style.display="inline-block";a.querySelector(".bearcms-comments-element-text-input").setAttribute("readonly","readonly")},onFormResponseReceived:function(a){a=
a.target;a.querySelector(".bearcms-comments-element-send-button").style.display="inline-block";a.querySelector(".bearcms-comments-element-send-button-waiting").style.display="none";a.querySelector(".bearcms-comments-element-text-input").removeAttribute("readonly")},onFocusTextarea:function(a){c(a)&&a.target.blur();a=a.target.parentNode;"none"===a.querySelector(".bearcms-comments-element-send-button-waiting").style.display&&(a.querySelector(".bearcms-comments-element-send-button").style.display="inline-block")}}}();