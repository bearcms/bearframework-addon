...
?><html>
    ...
    <body><?php
        ...
        echo '</form>';
        echo '<script id="bearcms-bearframework-addon-script-7" src="' . htmlentities($context->assets->getUrl('components/bearcmsForumPostsElement/assets/forumPostNewForm.js', ['cacheMaxAge' => 999999, 'version' => 1])) . '" async></script>';
        ?></body>
</html>