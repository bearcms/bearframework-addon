...
$content .= '<script id="bearcms-bearframework-addon-script-9" src="' . htmlentities($context->assets->getUrl('components/bearcmsForumPostsElement/assets/forumPostsElement.js', ['cacheMaxAge' => 999999, 'version' => 1])) . '" async></script>';
$content .= '<script id="bearcms-bearframework-addon-script-4" src="' . htmlentities($context->assets->getUrl('assets/HTML5DOMDocument.min.js', ['cacheMaxAge' => 999999, 'version' => 1])) . '" async></script>';
