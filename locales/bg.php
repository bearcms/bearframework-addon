...
return [
    ...
    'bearcms.errorPage.temporaryUnavailable.message' => 'Възникна технически проблем и сайтът е временно недостъпен.' . "\n" . 'Моля, опитайте отново след няколко минути.',
    'bearcms.errorPage.notFound.message' => 'Страницата, която търсите не съществува.',
    'bearcms.errorPage.notFound.link' => 'Към началната страница',
    ...
    'bearcms.themes.options.slider.Indicators' => 'Индикатори',
    'bearcms.themes.options.slider.IndicatorSelected' => 'Избран',
];
