...
if ($hasFormsSupport) {
    ...
    $optionsValues = array_merge($optionsValues, [
        ...
        'FormFieldDateCSS' => '{' . $elementInputJSON . '}',
        'FormFieldDateLabelCSS' => '{' . $elementLabelJSON . '}',
        'FormFieldDateHintCSS' => '{' . $formFieldHintJSON . '}',
        'FormFieldDateContainerCSS' => '{' . $formFieldContainerJSON . '}',
        'FormFieldTimeCSS' => '{' . $elementInputJSON . '}',
        'FormFieldTimeLabelCSS' => '{' . $elementLabelJSON . '}',
        'FormFieldTimeHintCSS' => '{' . $formFieldHintJSON . '}',
        'FormFieldTimeContainerCSS' => '{' . $formFieldContainerJSON . '}',
        'FormFieldDateTimeCSS' => '{' . $elementInputJSON . '}',
        'FormFieldDateTimeLabelCSS' => '{' . $elementLabelJSON . '}',
        'FormFieldDateTimeHintCSS' => '{' . $formFieldHintJSON . '}',
        'FormFieldDateTimeContainerCSS' => '{' . $formFieldContainerJSON . '}',
